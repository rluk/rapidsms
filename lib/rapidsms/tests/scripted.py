    ...
    def runParsedScript (self, cmds):
        ...
        for num, date, dir, txt in cmds:
            if dir == '>':
                ...
                # The following 3 try...catch blocks attempt to print rich info on exceptions
                # However, sometimes
                #     "%s %s" % (x,y) 
                # can generate errors when x and y have incompatible encodings. I'm still tracking
                # down the root of this problem, but in the interim, this works.
                try:
